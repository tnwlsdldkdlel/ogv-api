...
import ogv.api.security.APILoginFailHandler;
import ogv.api.security.APILoginSuccessHandler;
import ogv.api.security.CustomAccessDeniedHandler;
...
public class CustomSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.formLogin(config -> {
			...
			config.loginPage("/v1/admin/auth");
